...
const wt = await agent(
  ...
  { model: 'haiku', isolation: 'worktree', schema: WT_SCHEMA, label: 'worktree:writer', phase: 'Worktree' },
)
const main = await agent(
  ...
  { model: 'haiku', schema: MAIN_SCHEMA, label: 'worktree:main-checker', phase: 'Worktree' },
)
