...
try {
  results = await parallel([
    () => agent('Reply with exactly this single word and nothing else: alpha', { model: 'gpt-5.6-luna', label: 'par:alpha', phase: 'Parallel' }),
    () => agent('Reply with exactly this single word and nothing else: beta', { model: 'gpt-5.6-luna', label: 'par:beta', phase: 'Parallel' }),
